  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserDetailsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserDetailsRecord> transactionUserDetailsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final transactionUserDetailsRecord =
            transactionUserDetailsRecordList.isNotEmpty
                ? transactionUserDetailsRecordList.first
                : null;
