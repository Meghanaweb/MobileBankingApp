...
class SearchContactsWidget extends StatefulWidget {
  const SearchContactsWidget({Key? key}) : super(key: key);

  @override
  _SearchContactsWidgetState createState() => _SearchContactsWidgetState();
}
                                ...
                                onChanged: (_) => EasyDebounce.debounce(
                                  ...
                                  () async {
                                    if (FFAppState().search != null) {
                                      await queryContactsDetailsRecordOnce()
                                          .then(
                                            (records) =>
                      ...
                      children: [
                          ...
                          Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => Builder(
                                builder: (context) {
                                  final list = _model.simpleSearchResults
                                      .where((e) =>
                        ...
                        if (!FFAppState().search)
                          Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) =>
                                  FutureBuilder<List<ContactsDetailsRecord>>(
                                future: queryContactsDetailsRecordOnce(
                                  queryBuilder: (contactsDetailsRecord) =>
                                      contactsDetailsRecord.where(
                                          'ContactAccountType',
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<ContactsDetailsRecord>
                                      listViewContactsDetailsRecordList =
                                      snapshot.data!;
                                  return ListView.builder(
                                    padding: EdgeInsets.zero,
                                    shrinkWrap: true,
                                    scrollDirection: Axis.vertical,
                                    itemCount: listViewContactsDetailsRecordList
                                        .length,
                                    itemBuilder: (context, listViewIndex) {
                                      final listViewContactsDetailsRecord =
                                          listViewContactsDetailsRecordList[
                                              listViewIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
